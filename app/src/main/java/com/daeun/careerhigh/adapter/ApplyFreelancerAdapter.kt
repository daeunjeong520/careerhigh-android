...
import com.daeun.careerhigh.databinding.ItemFreelancerBinding
import com.daeun.careerhigh.vo.response.FreelancerInfo

class ApplyFreelancerAdapter(val onClick: (FreelancerInfo) -> Unit): ListAdapter<FreelancerInfo, ApplyFreelancerAdapter.ViewHolder>(ApplyFreelancerAdapter.diffUtil) {
    private lateinit var uri: Uri

    inner class ViewHolder(private val viewBinding: ItemFreelancerBinding) : RecyclerView.ViewHolder(viewBinding.root) {
